<script>
    ...
    const handleSubmit = async () => {
        const response = await axios.post('http://localhost:3000/investments', {amount, type, duration}, {
            headers: {
  ...
  <div class="modal-box relative">
    ...
    <form action="">
        ...
        <div class="form-control w-full max-w-xs mx-auto">
            ...
            <input type="range" min="0" max="12" class="range" step="1" id="duration" bind:value={duration} required/>
        ...
        <div class="modal-action">
            <button id="submit-button" type="submit" class="btn btn-primary" on:click={validateInput}>Invest</button>
        </div>
    </form>
  </div>
</div>